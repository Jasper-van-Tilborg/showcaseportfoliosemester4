          ...
          <aside className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="glass-panel p-8 rounded-3xl border border-outline-variant/15 flex flex-col justify-between min-h-[240px] relative overflow-hidden">
              <div>
                ...
                <p className="text-on-surface-variant font-body leading-relaxed">
                  Available for remote work globally &amp; local meetings within the
                  Netherlands.
                </p>
              </div>
            </div>
                ...
                {[
                  {
                    icon: "mail",
                    label: "Email",
                    value: "547118@student.fontys.nl",
                    href: "mailto:547118@student.fontys.nl",
                  },
                  {
                    icon: "open_in_new",
                    label: "LinkedIn",
                    value: "linkedin.com/in/jaspervantilborg",
                  ...
                  >
                    <div className="w-12 h-12 rounded-xl bg-surface-container-high flex items-center justify-center group-hover:bg-primary-container transition-colors duration-300 shrink-0">
                      <Icon
                        name={icon}
                        className="text-on-surface-variant group-hover:text-on-primary-fixed transition-colors"
                      />
                    </div>
                    <div>
                      <p className="text-xs uppercase tracking-widest text-on-surface-variant font-bold font-label">
                        {label}
                      </p>
                      <p className="text-on-surface group-hover:text-primary transition-colors font-body text-sm">
                        {value}
                      </p>
                    </div>
                  </a>
            ...
            <div className="flex gap-4">
              {["LinkedIn", "GitHub"].map((name) => (
                ...
                >
                  <span className="font-headline font-bold text-xs tracking-widest uppercase text-on-surface">
                    {name}
                  </span>
                </a>
              ))}
