    ...
    <section className="max-w-screen-2xl mx-auto px-8 md:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-end mb-20">
      ...
      <div className="lg:col-span-5 order-2 lg:order-1">
        ...
        >
          Media
          <br />
          <span className="text-on-surface-variant">Designer</span>
        </motion.h1>
        ...
        >
          Bridging the gap between strategic thinking and visual execution. I
          craft purposeful brand experiences for the next generation of digital
          media.
        </motion.p>
      ...
      >
        <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl glass-card">
